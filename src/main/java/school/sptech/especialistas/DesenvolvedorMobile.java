...
public class DesenvolvedorMobile extends Desenvolvedor {
    ...
    public DesenvolvedorMobile(String nome, Integer qtdHotras, Double valorHora, String plataforma, String linguagem, Integer horasPrototipacao) {
        super(nome, qtdHotras, valorHora);
